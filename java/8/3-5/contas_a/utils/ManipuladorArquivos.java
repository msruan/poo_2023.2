...
public class ManipuladorArquivos {
    ...
    public static void escreverEmArquivo(String caminho, String conteudo){
        try ( BufferedWriter buffwriter = new BufferedWriter(
                ...
                System.out.println("Erro IO durante a tentativa de salvar conteúdo em "+caminho);
                e.printStackTrace();
            }catch(RuntimeException e){
                System.out.println("Erro desconhecido durante a tentativa de salvar conteúdo em "+caminho);
            }
    }
}